      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <h1 className="font-heading text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="font-heading text-xl font-bold">Mecánica General</h3>
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="font-heading text-xl font-bold">Revisiones Oficiales</h3>
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="font-heading text-xl font-bold">Neumáticos</h3>
                <p className="text-center text-gray-500">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="font-heading text-xl font-bold">Mantenimiento</h3>
                <p className="text-center text-gray-500">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <h3 className="font-heading text-xl font-bold">Electricidad</h3>
                <p className="text-center text-gray-500">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <Car className="h-12 w-12 text-primary" />
                <h3 className="font-heading text-xl font-bold">Aire Acondicionado</h3>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="font-heading text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Contacto</h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
